    ...
    <div class="m-top m-bottom">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th>Позитивный ответ</th>
                <th>Принадлежность к вопросу</th>
                <th>Изменить</th>
                <th>Удалить</th>
            </tr>
            </thead>
                ...
                @if($option)
                    @foreach($option as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('option.edit', $item->id) }}" class="btn btn-primary">Изменить</a>
                            </td>
                            <td>
                                <form method="post" action="{{ route('option.destroy', $item->id) }}">
                                    @csrf
                                    @method('delete')
