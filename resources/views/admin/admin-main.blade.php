            ...
            <div class="calc__body">
                    ...
                    <ul class="categories__list">
                        ...
                        <li class="benefits__category-container">
                            <a href="{{ route('subject.index') }}" class="benefits__category">Список опросов</a>
                        </li>
                        <li class="benefits__category-container">
                                <div class="button-container">
                                    <a href="{{url ('admin/categories')}}" class="button">Редактировать</a>
                                </div>
                        </li>
                    </ul>
                </div>
                        ...
                        <li class="benefits__benefit-container" data-benefit="{{ $item->category_id }}">
                            ...
                            <div class="buttons-container">
                                <div class="button-container hover">
                                    <a href="{{url('admin/edit-benefit/'.$item->id)}} " class="button">Редактировать</a>
                                </div>
                                <div class="button-container hover">
                                    <a href=" {{ url('admin/delete-benefit/'.$item->id) }} " class="button red">Удалить</a>
                                </div>
                            </div>
                        </li>
