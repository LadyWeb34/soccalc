    ...
    <div class="container container">
      <div class="container__container">
                    ...
                    @foreach($category as $item)
                        <tr>
                            ...
                            <td class="green center">
                                <a href=" {{url('admin/edit-category/'.$item->id)}} " class="btn btn-succes green ">Изменить</a>
                            </td>
                            <td class="red center">
                                <a href="{{ url('admin/delete-category/'.$item->id) }}" class="btn btn-succes red ">Удалить</a>
                            </td>
                        </tr>
                    @endforeach
              </tbody>
        ...
        <div class="button-container">
            <a href="{{ url('admin/add-category') }}" class="button">Добавить</a>
        </div>
    </div>
</main>
